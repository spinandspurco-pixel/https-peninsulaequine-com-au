...
('Eleanor Whitcombe',  'eleanor.w@example.com',     '0400 000 000', ARRAY['arena-construction','fencing'],                      'Covered dressage arena with shedrow and 4-stable barn, Red Hill ridge site.',                          '250k-plus',  'Q2 2026',  'experienced',   'new',         'new',               420000, 30, 'premium',  ARRAY['construction','priority:arenas'],            true, now() - interval '2 days'),
('James Holloway',     'j.holloway@example.com',    '0400 000 000', ARRAY['full-facility'],                                       '12-acre property, full build: 6 stables, lunge ring, hay storage, manager cottage.',                  '250k-plus',  'Q1 2027',  'professional',  'qualified',   'qualified',         780000, 55, 'premium',  ARRAY['full-build','pro-client'],                   true, now() - interval '6 days'),
('Margaux Devereux',   'margaux.d@example.com',     '0400 000 000', ARRAY['arena-construction'],                                  'Replace failing surface, add geotextile base. Existing arena 60x20.',                                  '50k-100k',   'asap',     'experienced',   'qualified',   'scope_review',       82000, 60, 'high',     ARRAY['construction'],                              true, now() - interval '11 days'),
('Hugo Pemberton',     'hugo.p@example.com',        '0400 000 000', ARRAY['barn-construction','infrastructure'],                  'American barn, 8 boxes, vet bay, wash bay. Power + water already on site.',                            '100k-250k',  'Q3 2026',  'experienced',   'in-progress', 'quote_in_progress', 215000, 65, 'premium',  ARRAY['construction','site-work'],                  true, now() - interval '18 days'),
('Annika Sørensen',    'annika.s@example.com',      '0400 000 000', ARRAY['arena-construction','renovations'],                    'Renovate existing covered arena. Kickboards, irrigation, lighting upgrade.',                            '50k-100k',   'Q2 2026',  'professional',  'in-progress', 'quote_sent',         96500, 75, 'high',     ARRAY['renovation','pro-client'],                   true, now() - interval '24 days'),
('Roderick Ashworth',  'r.ashworth@example.com',    '0400 000 000', ARRAY['fencing','round-pens'],                                'Post-and-rail boundary 1.2km plus two round pens. Main Ridge property.',                                '15k-50k',    'asap',     'intermediate',  'in-progress', 'quote_sent',         44800, 40, 'standard', ARRAY['site-work'],                                 true, now() - interval '31 days'),
('Catriona Mackelvie', 'catriona.m@example.com',    '0400 000 000', ARRAY['full-facility'],                                       'New build, ground-up. 25 acres, dual-discipline (jumping + dressage).',                                 '250k-plus',  'Q4 2026',  'professional',  'completed',   'won',              1140000, 100,'premium',  ARRAY['full-build','pro-client'],                   true, now() - interval '47 days'),
('Tobias Lindqvist',   'tobias.l@example.com',      '0400 000 000', ARRAY['arena-construction'],                                  'Indoor arena, 70x30, structural engineering already drafted.',                                          '100k-250k',  'Q2 2026',  'experienced',   'archived',    'closed',            175000, 0,  'high',     ARRAY['construction'],                              true, now() - interval '62 days');
...
('Isabella Carrington', 'isabella.c@example.com', '0400 000 000', 'apply-to-build',  'Looking to build a 6-stable facility in Main Ridge. Approx 8 acres, existing access. Budget around $400k.',                                 'apply-to-build',  true),
('Marcus Whitley',      'marcus.w@example.com',   '0400 000 000', 'apply-to-build',  'Full estate masterplan, 22 acres in Red Hill South. Looking for end-to-end service.',                                                       'apply-to-build',  true),
('Elena Brookbank',     'elena.b@example.com',    '0400 000 000', 'site-assessment', 'Existing arena needs full assessment. Drainage issues + surface failing.',                                                                  'apply-to-build',  true),
('Sebastian Quayle',    'seb.q@example.com',      '0400 000 000', 'apply-to-build',  'Considering relocating from Sydney. Need land + build advice.',                                                                            'apply-to-build',  true),
('Penelope Hartwig',    'p.hartwig@example.com',  '0400 000 000', 'general',         'Interested in lessons + future build conversation.',                                                                                        'apply-to-build',  true),
('Oliver Brennan',      'o.brennan@example.com',  '0400 000 000', 'apply-to-build',  'Replacing aging round pens and adding new shedrow. Mid-range budget.',                                                                     'apply-to-build',  true);
