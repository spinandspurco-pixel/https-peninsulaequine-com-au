    ...
    <Layout>
      ...
      <section className="relative pt-32 pb-20 bg-primary text-primary-foreground overflow-hidden">
        ...
        <div className="section-container relative z-10 text-center max-w-2xl mx-auto space-y-4">
          <p className="text-overline text-accent tracking-[0.25em]">Our Story</p>
        ...
        <div className="section-container max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {aboutCiro.values.map((value, i) => (
              <div
                key={value.title}
                className="group text-center p-6 rounded-lg border border-border bg-background transition-all duration-300 hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5"
              >
