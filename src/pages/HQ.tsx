...
export default function HQ() {
  ...
  return (
    <Layout>
      <StaffPortalFrame
        title="HQ Access"
        subtitle="Secure staff portal with role-based access control."
      >
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-card px-3 text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60">
                  or
                </span>
              </div>
            </div>
        ...
        <div className="text-center mt-6">
          <a href="/" className="inline-flex items-center gap-1.5 text-[11px] text-muted-foreground/50 hover:text-accent transition-colors uppercase tracking-[0.1em]">
