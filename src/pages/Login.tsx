...
import { Eye, EyeOff, LogIn, Shield, Loader2, ArrowLeft, Fingerprint } from "lucide-react";
...
export default function Login() {
      ...
      <Layout>
        <div className="min-h-[80vh] flex items-center justify-center bg-primary">
          <div className="text-center space-y-4">
            ...
            <p className="text-primary-foreground/60 text-sm uppercase tracking-[0.15em]">Authenticating…</p>
          </div>
        </div>
      </Layout>
    );
  ...
  return (
    <Layout>
      <StaffPortalFrame
        title="Staff Portal"
        subtitle="Blueprint-grade security. Sign in with your Peninsula Equine credentials to access your dashboard, tasks, and team communications."
      >
        <Card className="w-full max-w-md border-accent/20 bg-card/95 backdrop-blur-lg shadow-2xl shadow-primary/20">
          <CardHeader className="text-center space-y-4 pb-2">
            ...
            <div>
              ...
              <CardDescription className="mt-1 text-muted-foreground/80">
                Secure staff access — role-based routing on sign in
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="space-y-5">
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-xs uppercase tracking-[0.1em] text-muted-foreground">Password</Label>
            ...
            <div className="pt-4 border-t border-border/30 space-y-3">
              <div className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <p>
                  Staff accounts are created by your administrator. Need access? Contact{" "}
