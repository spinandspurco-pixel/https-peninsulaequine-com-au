// Content data for Peninsula Equine
...
export const services = [
  {
    ...
    features: [
      ...
      "Proper grade and crown engineering",
  ...
  },
  {
    ...
    features: [
      ...
      "Safe footing materials",
      "Integrated gates and panels",
...
export const galleryItems = [
  {
    id: 1,
    title: "Covered Arena at Sunset",
    category: "Arenas",
    description: "60x120 covered arena with dust-free footing",
  },
  {
    id: 2,
    title: "Ciro with Client's Horse",
    category: "People",
    description: "Building relationships beyond construction",
  },
  {
    id: 3,
    title: "Training Session",
    category: "Action",
    description: "Quality arenas enable quality training",
  },
  {
    id: 4,
    title: "Craftsmanship Details",
    category: "Details",
    description: "Attention to the finest details",
  },
  {
    id: 5,
    title: "Hands-On Approach",
    category: "People",
    description: "Understanding what horses need",
  },
  {
    id: 6,
    title: "Equipment Details",
    category: "Details",
    description: "Professional equipment, professional results",
  },
];
...
export const aboutCiro = {
  ...
  bio: [
    ...
    "His portfolio speaks to the breadth of his craft: hand-laid stonework stables at Aberdeen Farm, precision timber joinery at Main Ridge, full-scale competition infrastructure for Equitana (Melbourne, Victoria), and arena preparation for Melbourne Racing Club's Ranch Roundup at Caulfield. Whether it's a bespoke four-stall barn on a private property or a multi-arena event complex, Ciro brings the same uncompromising standard—because he knows the details a horse notices are rarely the ones a typical contractor thinks about.",
