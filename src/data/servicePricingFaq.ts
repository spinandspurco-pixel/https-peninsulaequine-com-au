...
export const servicePricingTiers: Record<string, PricingTier[]> = {
  "arena-construction": [
    ...
    { name: "Competition", price: "$350,000+", description: "Competition-grade covered arena", features: ["60×80m+ covered arena structure", "Engineered stabilised surface system", "All-weather premium footing", "Full LED lighting & PA infrastructure", "Spectator viewing areas", "Warm-up zone integration", "Council approvals managed"] },
  ],
  "barn-construction": [
  ...
  "infrastructure": [
    ...
    { name: "Turnkey", price: "$220,000+", description: "End-to-end property setup", features: ["All Full Site features", "Stabilised surface system across all zones", "Bore/well installation", "Landscaping & revegetation", "Site-wide LED lighting", "Waste management systems", "Full council & engineering management"] },
  ],
  "round-pens": [
