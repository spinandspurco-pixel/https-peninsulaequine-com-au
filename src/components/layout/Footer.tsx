            ...
            <ul className="space-y-2.5">
              {footerLinks.services.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="text-sm text-[hsl(var(--footer-muted))] hover:text-[hsl(var(--footer-hover))] transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-sm text-[hsl(var(--footer-muted))] hover:text-[hsl(var(--footer-hover))] transition-colors"
                >
              ...
              <li className="flex items-start gap-3 text-sm text-[hsl(var(--footer-muted))]">
