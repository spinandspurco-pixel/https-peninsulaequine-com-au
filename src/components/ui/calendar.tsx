      ...
      <DayPicker
        ...
        classNames={{
          ...
          day: cn(
            ...
            "focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:z-30",
          ),
        ...
        labels={{
          ...
          labelDay: (day, modifiers) => {
            ...
            if (modifiers?.today) parts.push("(today)");
            if (modifiers?.selected) parts.push("(selected)");
            if (modifiers?.disabled) parts.push("(unavailable)");
            return parts.join(" ");
          },
          labelWeekday: (day) =>
